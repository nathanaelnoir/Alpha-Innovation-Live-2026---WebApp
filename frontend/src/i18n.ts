...
export const copy = {
  en: {
    ...
    balanceInstruction: 'Move toward a label when it applies more strongly.',
    balanced: 'Balanced',
  ...
  de: {
    ...
    balanceInstruction: 'Bewegen Sie den Punkt zu dem Begriff, der stärker zutrifft.',
    balanced: 'Ausgewogen',
    horizontal: 'Horizontal',
    vertical: 'Vertikal',
  ...
  it: {
    ...
    balanceInstruction: 'Sposti il punto verso il termine che si applica maggiormente.',
    balanced: 'Equilibrio',
